/* Сабсет шрифтов: одно семейство — один файл.
   ...
   Onest — один гротеск на весь сайт: характер задаётся весом, а не второй
   гарнитурой. Содержит кириллицу, знак рубля, «м²» и «№», поэтому запасных
...
const UNICODES = [
  ...
  'U+2116', 'U+2190', 'U+2192', 'U+2212', 'U+20BD', 'U+00A9'
].join(',');

const FAMILIES = [
  { src: 'Onest.ttf', out: 'onest-wght.woff2' }
];
